...
class LineAnalyzer
  ...
  def calculate_word_frequency
    ...
    @highest_wf_count = counter.values.max
...
class Solution
  ...
  attr_accessor :analyzers, :line_number
  ...
  def analyze_file
    ...
    File.foreach('test.txt') do |content|
      line_analyzer = LineAnalyzer.new(content, line_number)
  ...
  def calculate_line_with_highest_frequency
    ...
    @analyzers.each do |line_analyzer|
      ...
      elsif line_analyzer.highest_wf_count == @highest_count_across_lines
        @highest_count_words_across_lines << line_analyzer
      else
      end
    end
  ...
  def print_highest_word_frequency_across_lines
    ...
    line_number = @highest_count_words_across_lines.map(&:highest_wf_count).max
    puts "#{words_found} (appears in line #{line_number})"
  end
end
